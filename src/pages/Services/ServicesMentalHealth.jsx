      ...
      <header className="bg-mentalHealth text-white w-full py-10">
        <div className="max-w-[86rem] mx-auto flex items-center justify-between px-4">
          <article className="space-y-5 flex flex-col items-center lg:items-start text-center w-full">
            ...
            <Link to="/register">
              <button className="rounded-full w-[260px] text-lg flex justify-center py-2 border bg-white text-[#3F3F3F] border-white hover:opacity-80 transition-opacity ease-in-out duration-300">
                {t('sign-up-today')}
              </button>
            </Link>
          </article>
