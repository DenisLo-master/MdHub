          ...
          <article className="py-10 pl-16 rounded-lg">
            ...
            <ul className="font-body space-y-6 font-light text-lg">
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('24-7-access-to-real-doctors')} </span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('prescription-by-doctors')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('free-online-pharmacy')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('individual-family-or-corporate-coverage')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('quick-and-discounted-access-to-medical-specialists')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('worldwide-access-to-telemedicine')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('headspace-app')}</span>
              </li>
              <li className="flex items-center gap-x-5">
                <CloseVector /> <span>{t('centralized-health-records-and-platform')}</span>
              </li>
            </ul>
          </article>
