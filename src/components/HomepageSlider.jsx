...
const HomepageSlider = () => {
  ...
  return (
    <section>
      <div className="hidden slick-lg lg:block mx-auto font-main h-[612px] px-24 text-primary w-full max-w-[1500px]">
      ...
      <div className="slick-mobile block lg:hidden font-main">
        <Slider {...mobileSliderSettings}>
          <article>
            <Link className="block" to="/services/mental-health">
              <div className="bg-[#ECB118] text-white p-6 w-[300px]  rounded-[8px] mx-auto flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/mental-health">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link className="block" to="/services">
              <div className="bg-[#A293FF] text-white p-6 w-[300px]  3xl:w-[330px] rounded-[8px] mx-auto flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link className="block" to="/services/online-pharmacy">
              <div className="bg-[#90C387] text-white p-6 w-[300px]  3xl:w-[330px] mx-auto rounded-[8px] flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/online-pharmacy">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link to="/services/nursing-homecare">
              <div className="bg-[#F78839] text-white p-6 w-[300px]  mx-auto 3xl:w-[330px] rounded-[8px] flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/nursing-homecare">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link to="/services/diagnostics">
              <div className="bg-diagnostics text-white p-6 w-[300px]  mx-auto 3xl:w-[330px] rounded-[8px] flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/diagnostics">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
