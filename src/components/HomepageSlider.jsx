    ...
    <section>
      ...
      <div className="block lg:hidden font-main h-[400px]">
        <Slider {...mobileSliderSettings}>
          ...
          <article>
            <Link className="block" to="/services/online-pharmacy">
              <div className="bg-[#90C387] text-white p-6 w-[300px] h-[400px] 3xl:w-[330px] rounded-[8px] mx-4 flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/online-pharmacy">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link to="/services/nursing-homecare">
              <div className="bg-[#F78839] text-white p-6 w-[300px] h-[400px] 3xl:w-[330px] rounded-[8px] mx-4 flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/nursing-homecare">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
          ...
          <article>
            <Link to="/services/diagnostics">
              <div className="bg-diagnostics text-white p-6 w-[300px] h-[400px] 3xl:w-[330px] rounded-[8px] mx-4 flex flex-col justify-end relative">
                <div className="absolute bottom-0 left-0 w-full flex flex-row-reverse p-4">
                  <Link to="/services/diagnostics">
                    <img src={RedirectIcon} alt="redirect" />
                  </Link>
