    ...
    <section className="relative w-full font-main py-8 lg:pb-20">
      <div className="w-full max-w-7xl mx-auto flex gap-y-5 gap-x-12 flex-col-reverse lg:flex-row justify-between">
        ...
        <div className="flex-1 pt-10 flex flex-col gap-y-4 px-4 text-center lg:text-left">
          ...
          <p className="font-body max-w-[680px] text-2xl pb-6">{t('virtual-and-physical-healthcare-services-through-an-affordable-membership-offering-mobile-nursing-pharmacy-lab-testing-and-mental-health-specialists')}</p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <article className='flex flex-col items-center'>
              <img className="w-20 h-20" src={MembershipBenefit01} alt="Membership benefit" />
              <h2 className="text-center max-w-[150px] pt-2">{t('access-to-canadian-certified-doctors-24-7')}</h2>
            </article>
            <article className='flex flex-col items-center'>
            ...
            <article className='flex flex-col items-center'>
              ...
              <h2 className="text-center max-w-[170px] pt-2">{t('access-to-qualified-mobile-nurses')}</h2>
            </article>
            <article className='flex flex-col items-center'>
              <img className="w-20 h-20" src={MembershipBenefit05} alt="Membership benefit" />
              <h2 className="text-center max-w-[170px] pt-2">{t('access-specialist-doctors-at-discounted-rates')}</h2>
            </article>
