...
const MentalHealthServices = () => {
  ...
  return (
    <section className="bg-[#F6E2B0] text-white w-full lg:h-[530px] py-10 relative">
      <div className="max-w-[83rem] mx-auto flex flex-col justify-center h-full">
        <article className="px-4 space-y-5 flex flex-col items-center lg:items-start text-center">
          ...
          <div className="space-y-5 font-body text-lg max-w-lg">
            <p className="text-center lg:text-left text_black text-base leading-4">
              {t('We can all use a little help sometimes. Get mental health care and support with MDHUB’s suite of mental health services, so you can feel your best.')}
            </p>
          </div>
        ...
        <img className="hidden lg:block absolute right-5 top-5" src={Yellow} alt="virtual doctor" />
      </div>
